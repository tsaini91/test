...
function licenseNumberToCatJson(licenseNumber) {
	...
	var licenseType = "Cannabis - " + capSubType + " License";
	// exceptions to naming convention
	if ("Distributor-Transport Only".equals(capSubType)) {
		licenseType = "Cannabis - Distributor-Transport Only";
	} 
	if ("Testing".equals(capSubType)) {
		licenseType = "Cannabis - Testing Laboratory License";
	} 
