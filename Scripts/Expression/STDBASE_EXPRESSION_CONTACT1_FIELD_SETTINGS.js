...
var thisForm = expression.getValue("CONTACT1::FORM")
...
var contactType=expression.getValue("CONTACT1::contactsModel*contactType");
var birthDate=expression.getValue("CONTACT1::contactsModel*birthDate");
var ssn = expression.getValue("CONTACT1::contactsModel*maskedSsn");
var fein = expression.getValue("CONTACT1::contactsModel*fein");
var driverLicenseNum = expression.getValue("CONTACT1::contactsModel*driverLicenseNbr");
var driverLicenseState = expression.getValue("CONTACT1::contactsModel*driverLicenseState");
var businessName=expression.getValue("CONTACT1::contactsModel*businessName");
var dbaTradeName=expression.getValue("CONTACT1::contactsModel*tradeName");

var firstName=expression.getValue("CONTACT1::contactsModel*firstName");
var middleName=expression.getValue("CONTACT1::contactsModel*middleName");
var lastName=expression.getValue("CONTACT1::contactsModel*lastName");
var fullName=expression.getValue("CONTACT1::contactsModel*fullName");

var phone1=expression.getValue("CONTACT1::contactsModel*phone1");
var phone2 = expression.getValue("CONTACT1::contactsModel*phone2");
var phone3=expression.getValue("CONTACT1::contactsModel*phone3");
var fax=expression.getValue("CONTACT1::contactsModel*fax");
var email=expression.getValue("CONTACT1::contactsModel*email");

var addressLine1=expression.getValue("CONTACT1::contactsModel*addressLine1");
var addressLine2=expression.getValue("CONTACT1::contactsModel*addressLine2");
var addressLine3=expression.getValue("CONTACT1::contactsModel*addressLine3");
var city=expression.getValue("CONTACT1::contactsModel*city");
var state=expression.getValue("CONTACT1::contactsModel*state");
var zip=expression.getValue("CONTACT1::contactsModel*zip");
